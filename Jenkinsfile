/* pipeline 변수 설정 */
def DOCKER_IMAGE_NAME = "meadow215/springtest-repo"           // 생성하는 Docker image 이름
def DOCKER_IMAGE_TAGS = "1.0"                                 // 생성하는 Docker image 태그
def NAMESPACE = "mypring-project"
...
podTemplate(label: 'builder',
            containers: [
                ...
                containerTemplate(name: 'kubectl', image: 'lachlanevenson/k8s-kubectl:v1.26.1', command: 'cat', ttyEnabled: true)
            ],
            volumes: [
                ...
                withCredentials([usernamePassword(
                    ...
                    passwordVariable: 'PASSWORD')]) {
                        ...
                        sh """
                            ...
                            --docker-email=meadow21@naver.com \
                            -n ${NAMESPACE}
                        """
